    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div>
                ...
                <a href="page/penjualan/cetak/cetak-detail-penjualan-thermal.php?no_invoice=<?php echo $data['no_invoice']; ?>" target='blank' class="btn btn-success btn-icon-split"><span class="text"><i class="fas fa-print"></i> Print </span></a>
            </div>
            <!--rows -->
        </div>
    </div>
