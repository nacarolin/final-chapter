...
<head>
  ...
  <link rel="icon" href="logo.png" type="image/x-icon">  <!-- Custom fonts for this template -->
...
<body>
  ...
  <div id="wrapper">
    ...
    <!-- Sidebar -->
    <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-image: linear-gradient(180deg, #D2691E 0%, #000000 100%);">
      <!-- Sidebar - Brand -->
...
<!-- Nav Item - Transaksi -->
<?php if ($_SESSION["level"] == "Kasir" || $_SESSION["level"] == "Owner") : ?>
    <li class="nav-item">
